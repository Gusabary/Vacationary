...
int main()
{
    ...
    lightingShader.setVec3f("material.diffuse", 0.0f, 0.5, 0.5);
    lightingShader.setVec3f("material.specular", 0.5, 0.5, 0.5);
    lightingShader.setFloat("material.shininess", 32.0f);

    lightingShader.setVec3f("light.position", lightPos);
    lightingShader.setVec3f("light.ambient", 1.0f, 1.0f, 1.0f); // note that all light colors are set at full intensity
    lightingShader.setVec3f("light.diffuse", 1.0f, 1.0f, 1.0f);
